...
class FlutterBluetoothSerial {
  ...
  Future<BluetoothBondState> getBondStateForAddress(String address) async {
    return BluetoothBondState.fromUnderlyingValue(await (_methodChannel
        .invokeMethod('getDeviceBondState', {"address": address}) as FutureOr<int>));
  }
  ...
  Future<List<BluetoothDevice>> getBondedDevices() async {
    final dynamic bonded = await (_methodChannel.invokeMethod('getBondedDevices'));
    final List list = bonded as List;
